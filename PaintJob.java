public class PaintJob {
    ...
    */
    public static void main(String[] args) {
        System.out.println("Number of buckets needed = " + getBucketCount(-3.4, 2.1, 1.5, 2));
        System.out.println("Number of buckets needed = " + getBucketCount(3.4, 2.1, 1.5, 2));
        System.out.println("Number of buckets needed = " + getBucketCount(2.75, 3.25, 2.5, 1));
        //Second method.
        System.out.println("\nBuckets needed = " + getBucketCount(-3.4, 2.1, 1.5));
        System.out.println("Buckets needed = " + getBucketCount(3.4, 2.1, 1.5));
        System.out.println("Buckets needed = " + getBucketCount(7.25, 4.3, 2.35));
        //Third method.
        System.out.println("\nBuckets needed = " + getBucketCount(3.4, 1.5));
        System.out.println("Buckets needed = " + getBucketCount(6.26, 2.2));
        System.out.println("Buckets needed = " + getBucketCount(3.26, 0.75));
    ...
    } // End of the first overloaded method.
    ...
    } // End of the second overloaded method.
    ...
    } //End of the third overloaded method.
